...
set path = ($BORNAGAINSYS/bin $path)

if ($?LD_LIBRARY_PATH) then
   setenv LD_LIBRARY_PATH $BORNAGAINSYS/lib/BornAgain-1.17:$LD_LIBRARY_PATH      # Linux, ELF HP-UX
else
   setenv LD_LIBRARY_PATH $BORNAGAINSYS/lib/BornAgain-1.17
endif

if ($?DYLD_LIBRARY_PATH) then
   setenv DYLD_LIBRARY_PATH $BORNAGAINSYS/lib/BornAgain-1.17:$DYLD_LIBRARY_PATH  # Mac OS X
else
   setenv DYLD_LIBRARY_PATH $BORNAGAINSYS/lib/BornAgain-1.17
endif

if ($?SHLIB_PATH) then
   setenv SHLIB_PATH $BORNAGAINSYS/lib/BornAgain-1.17:$SHLIB_PATH                # legacy HP-UX
else
   setenv SHLIB_PATH $BORNAGAINSYS/lib/BornAgain-1.17
endif

if ($?LIBPATH) then
   setenv LIBPATH $BORNAGAINSYS/lib/BornAgain-1.17:$LIBPATH                      # AIX
else
   setenv LIBPATH $BORNAGAINSYS/lib/BornAgain-1.17
endif

if ($?PYTHONPATH) then
   setenv PYTHONPATH $BORNAGAINSYS/lib/BornAgain-1.17:$PYTHONPATH
else
   setenv PYTHONPATH $BORNAGAINSYS/lib/BornAgain-1.17
endif
