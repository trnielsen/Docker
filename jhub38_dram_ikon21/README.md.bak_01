...
| 8.  | McXtrace     |   | Dockerfile_jhub_py38_june_mcxtrace         |   | trnielsen/jhub38_dram_june_ds_mcxtrace      |   |
...
| 8.  |  trnielsen/jhub38_dram_june_ds_mcxtrace          | latest   | e191bdb2f372  | 46 hours ago  | 5.28GB   |   |
...
# Run
```console
$ docker run --name test_notebooks -p 8888:8888 -v  ~/Desktop:/Desktop -it trnielsen/jhub38_dram_june_ds_mcxtrace
```

# Docker Hub
* June  15 2021 (plus/minus a few days) 
* Tag: trnielsen/jhub38_dram_june_ds_mcxtrace -> trnielsen/jhub_py38_dram_mcxtrace
* Pushed trnielsen/jhub_py38_dram_mcxtrace to docker hub
* https://hub.docker.com/r/trnielsen/jhub_py38_dram_mcxtrace

```console
$ docker pull trnielsen/jhub_py38_dram_mxtrace
```
